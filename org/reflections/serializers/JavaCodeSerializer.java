...
public class JavaCodeSerializer implements Serializer
{
    ...
    public static Class<?> resolveClass(final Class aClass) {
        try {
            ...
            throw new ReflectionsException("could not resolve to class " + aClass.getName(), (Throwable)e);
        }
    }
    ...
    public static Field resolveField(final Class aField) {
        try {
            ...
            throw new ReflectionsException("could not resolve to field " + aField.getName(), (Throwable)e);
        }
    }
    ...
    public static Annotation resolveAnnotation(final Class annotation) {
        try {
            ...
            throw new ReflectionsException("could not resolve to annotation " + annotation.getName(), (Throwable)e);
        }
    }
        ...
        try {
            ...
            if (methodOgnl.contains("_")) {
                ...
                for (int i = 0; i < params.length; ++i) {
                    ...
                    paramTypes[i] = (Class<?>)ReflectionUtils.forName(typeName, new ClassLoader[0]);
                }
            }
            else {
            ...
            throw new ReflectionsException("could not resolve to method " + aMethod.getName(), (Throwable)e);
        }
    }
}
