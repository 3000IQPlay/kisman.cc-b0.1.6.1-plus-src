...
public class CompactConstructor extends Constructor
{
    ...
    protected Object createInstance(final ScalarNode node, final CompactData data) throws Exception {
        final Class<?> clazz = (Class<?>)this.getClassForName(data.getPrefix());
    ...
    static /* synthetic */ List access$000(final CompactConstructor x0, final SequenceNode x1) {
        return x0.constructSequence(x1);
    }
    
    static /* synthetic */ Object access$100(final CompactConstructor x0, final ScalarNode x1) {
    ...
    public class ConstructCompactObject extends Constructor.ConstructMapping
    {
        public ConstructCompactObject() {
            super((Constructor)CompactConstructor.this);
        }
        ...
        public void construct2ndStep(final Node node, final Object object) {
            ...
            if (valueNode instanceof MappingNode) {
                ...
                CompactConstructor.this.applySequence(object, CompactConstructor.access$000(CompactConstructor.this, (SequenceNode)valueNode));
            }
        }
        ...
        public Object construct(final Node node) {
            ...
            if (data == null) {
                return CompactConstructor.access$100(CompactConstructor.this, tmpNode);
            }
