...
public class Constructor extends SafeConstructor
{
    ...
    protected class ConstructMapping implements Construct
    {
        public Object construct(final Node node) {
            ...
            if (Map.class.isAssignableFrom(node.getType())) {
                ...
                final Object obj = Constructor.this.newInstance((Node)mnode);
                if (node.isTwoStepsConstruction()) {
                    return obj;
                }
        ...
        protected Object constructJavaBean2ndStep(final MappingNode node, final Object object) {
            ...
            for (final NodeTuple tuple : nodeValue) {
                ...
                final String key = (String)Constructor.this.constructObject((Node)keyNode);
                try {
    ...
    protected class ConstructScalar extends AbstractConstruct
    {
        public Object construct(final Node nnode) {
            ...
            try {
                return Constructor.this.newInstance((Class)type, (Node)node, false);
            }
        ...
        private Object constructStandardJavaInstance(final Class type, final ScalarNode node) {
            ...
            if (type == String.class) {
                ...
                final String ch = (String)charConstructor.construct((Node)node);
                if (ch.length() == 0) {
                    result = null;
                }
                else {
                ...
                final Date date = (Date)dateConstructor.construct((Node)node);
                if (type == Date.class) {
                    result = date;
                }
                else {
                ...
                result = Constructor.this.yamlConstructors.get(node.getTag()).construct((Node)node);
            }
            return result;
        }
    }
    ...
    protected class ConstructSequence implements Construct
    {
        public Object construct(final Node node) {
            ...
            if (Set.class.isAssignableFrom(node.getType())) {
                ...
                if (node.isTwoStepsConstruction()) {
                    return Constructor.this.createArray((Class)node.getType(), snode.getValue().size());
                }
        ...
        public void construct2ndStep(final Node node, final Object object) {
            ...
            if (List.class.isAssignableFrom(node.getType())) {
                ...
                Constructor.this.constructSequenceStep2(snode, (Collection)list);
            }
            else {
                if (!node.getType().isArray()) {
