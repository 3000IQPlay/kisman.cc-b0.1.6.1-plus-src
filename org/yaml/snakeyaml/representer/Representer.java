...
public class Representer extends SafeRepresenter
{
    ...
    protected MappingNode representJavaBean(final Set<Property> properties, final Object javaBean) {
        ...
        final Tag tag = (customTag != null) ? customTag : new Tag((Class)javaBean.getClass());
        final MappingNode node = new MappingNode(tag, (List)value, (Boolean)null);
    ...
    protected NodeTuple representJavaBeanProperty(final Object javaBean, final Property property, final Object propertyValue, final Tag customTag) {
        final ScalarNode nodeKey = (ScalarNode)this.representData((Object)property.getName());
    ...
    protected void checkGlobalTag(final Property property, final Node node, final Object object) {
        ...
        final Class<?>[] arguments = (Class<?>[])property.getActualTypeArguments();
        if (arguments != null) {
    ...
    protected Set<Property> getProperties(final Class<?> type) {
        ...
        return (Set<Property>)this.getPropertyUtils().getProperties((Class)type);
    }
    
    protected class RepresentJavaBean implements Represent
    {
        public Node representData(final Object data) {
            return (Node)Representer.this.representJavaBean(Representer.this.getProperties(data.getClass()), data);
        }
    }
}
