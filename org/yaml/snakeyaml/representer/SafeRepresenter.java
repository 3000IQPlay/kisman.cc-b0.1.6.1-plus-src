...
class SafeRepresenter extends BaseRepresenter
{
    ...
    public SafeRepresenter() {
        this.timeZone = null;
        this.nullRepresenter = (Represent)new RepresentNull();
        this.representers.put(String.class, new RepresentString());
        this.representers.put(Boolean.class, new RepresentBoolean());
        this.representers.put(Character.class, new RepresentString());
        this.representers.put(UUID.class, new RepresentUuid());
        this.representers.put(byte[].class, new RepresentByteArray());
        final Represent primitiveArray = (Represent)new RepresentPrimitiveArray();
    ...
    {
        public Node representData(final Object data) {
            return SafeRepresenter.this.representSequence(SafeRepresenter.this.getTag(data.getClass(), Tag.SEQ), (Iterable)data, (Boolean)null);
        }
    }
    ...
    protected class RepresentIterator implements Represent
    {
        public Node representData(final Object data) {
            ...
            return SafeRepresenter.this.representSequence(SafeRepresenter.this.getTag(data.getClass(), Tag.SEQ), (Iterable)new IteratorWrapper(iter), (Boolean)null);
        }
    }
    ...
    protected class RepresentArray implements Represent
    {
        public Node representData(final Object data) {
            ...
            return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)list, (Boolean)null);
        }
    }
    ...
    protected class RepresentPrimitiveArray implements Represent
    {
        public Node representData(final Object data) {
            ...
            if (Byte.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asByteList(data), (Boolean)null);
            }
            if (Short.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asShortList(data), (Boolean)null);
            }
            if (Integer.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asIntList(data), (Boolean)null);
            }
            if (Long.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asLongList(data), (Boolean)null);
            }
            if (Float.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asFloatList(data), (Boolean)null);
            }
            if (Double.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asDoubleList(data), (Boolean)null);
            }
            if (Character.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asCharList(data), (Boolean)null);
            }
            if (Boolean.TYPE == type) {
                return SafeRepresenter.this.representSequence(Tag.SEQ, (Iterable)this.asBooleanList(data), (Boolean)null);
            }
    ...
    protected class RepresentSet implements Represent
    {
        public Node representData(final Object data) {
            ...
            return SafeRepresenter.this.representMapping(SafeRepresenter.this.getTag(data.getClass(), Tag.SET), (Map)value, (Boolean)null);
        }
    }
    ...
    {
        public Node representData(final Object data) {
            final Tag tag = new Tag((Class)data.getClass());
    ...
    {
        public Node representData(final Object data) {
            return SafeRepresenter.this.representScalar(SafeRepresenter.this.getTag(data.getClass(), new Tag((Class)UUID.class)), data.toString());
        }
    }
}
