...
public class PropertySubstitute extends Property
{
    ...
    public Class<?>[] getActualTypeArguments() {
        if (this.parameters == null && this.delegate != null) {
            return (Class<?>[])this.delegate.getActualTypeArguments();
        }
    ...
    public <A extends Annotation> A getAnnotation(final Class<A> annotationType) {
        ...
        if (this.read != null) {
            ...
            annotation = (A)this.delegate.getAnnotation((Class)annotationType);
        }
        return annotation;
    }
    ...
    public Class<?> getType() {
        final Class<?> t = (Class<?>)super.getType();
        if (t != null) {
            return t;
        }
        return (Class<?>)((this.delegate != null) ? this.delegate.getType() : null);
    }
