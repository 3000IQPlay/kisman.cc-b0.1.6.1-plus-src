...
public class TypeDescription
{
    ...
    public Class<?> getListPropertyType(final String property) {
        if (this.properties.containsKey(property)) {
            final Class<?>[] typeArguments = (Class<?>[])this.properties.get(property).getActualTypeArguments();
    ...
    public void addPropertyParameters(final String pName, final Class<?>... classes) {
        if (!this.properties.containsKey(pName)) {
            ...
            pr.setActualTypeArguments((Class[])classes);
        }
    }
    ...
    private Property discoverProperty(final String name) {
        ...
        if (this.beanAccess == null) {
            return this.propertyUtils.getProperty((Class)this.type, name);
        }
        return this.propertyUtils.getProperty((Class)this.type, name, this.beanAccess);
    }
    ...
    public Property getProperty(final String name) {
        ...
        return (Property)(this.properties.containsKey(name) ? this.properties.get(name) : this.discoverProperty(name));
    }
    ...
    public void substituteProperty(final String pName, final Class<?> pType, final String getter, final String setter, final Class<?>... argParams) {
        this.substituteProperty(new PropertySubstitute(pName, (Class)pType, getter, setter, (Class[])argParams));
    }
    ...
    public void substituteProperty(final PropertySubstitute substitute) {
        ...
        substitute.setTargetType((Class)this.type);
    ...
    public Set<Property> getProperties() {
        ...
        final Set<Property> readableProps = (Set<Property>)((this.beanAccess == null) ? this.propertyUtils.getProperties((Class)this.type) : this.propertyUtils.getProperties((Class)this.type, this.beanAccess));
