...
public class GLSLSandboxShader
{
    ...
    public GLSLSandboxShader(final String name, final InputStream is) throws IOException {
        ...
        GL20.glAttachShader(program, this.createShader("assets/kismancc/shaders/passthrough.vsh", GLSLSandboxShader.class.getResourceAsStream("assets/kismancc/shaders/passthrough.vsh"), 35633));
    ...
    public int createShader(final String check, final InputStream inputStream, final int shaderType) throws IOException {
        ...
        if (compiled == 0) {
            ...
            Kisman.LOGGER.error("Caused by {}", (Object)check);
            return 0;
        }
        return shader;
    }
