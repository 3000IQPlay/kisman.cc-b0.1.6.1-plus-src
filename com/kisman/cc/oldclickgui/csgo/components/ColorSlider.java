...
public class ColorSlider extends AbstractComponent
{
    ...
    public ColorSlider(final IRenderer renderer, final double value, final double minValue, final double maxValue, final Slider.NumberType numberType, final int preferredWidth, final int preferredHeight) {
        super(renderer);
        this.changing = false;
        this.value = value;
    ...
    public ColorSlider(final IRenderer renderer, final double value, final double minValue, final double maxValue, final Slider.NumberType numberType) {
    ...
    public void render() {
        ...
        this.renderer.drawString(this.x + this.getWidth() / 2 - this.renderer.getStringWidth(text) / 2, this.y + this.renderer.getStringHeight(text) / 4, text, Window.FOREGROUND);
    }
