...
public class KeyBind extends Component
{
    ...
    public KeyBind(final Button b, final int offset) {
        this.drag = false;
        this.b = b;
        this.offset = offset;
        this.x = b.parent.x;
    ...
    public void renderComponent() {
        ...
        CustomFontUtil.drawCenteredStringWithShadow(this.binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.b.mod.getKey())), (float)(this.x + this.width / 2), (float)(this.y + 3 + this.offset + (height - CustomFontUtil.getFontHeight()) / 2), this.drag ? ColorUtils.astolfoColors(100, 100) : -1);
    }
