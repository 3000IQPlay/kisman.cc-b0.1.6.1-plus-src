...
public class InterpolationUtil
{
    ...
    public static boolean isNearlyEqual(final double value, final double value2, final double threshold) {
        final double boundValuePositive = value + threshold;
        final double boundValueNegative = value - threshold;
