...
public class SalFontRenderer
{
    ...
    public SalFontRenderer(final String fontName, final float fontSize) {
    ...
    public SalFontRenderer(final Font font) {
        this(font.getFontName(), (float)font.getSize());
    }
    
    public SalFontRenderer(final String fontName, final int fontType, final int size) {
    ...
    public static Font getFontFromInput(final String path) throws IOException, FontFormatException {
        final Font newFont = Font.createFont(0, SalFontRenderer.class.getResourceAsStream(path));
        if (newFont != null) {
            SalFontRenderer.font = newFont;
        }
        return SalFontRenderer.font;
    }
    ...
    public int drawString(final String text, float x, float y, final int color) {
        ...
        final String[] parts = SalFontRenderer.COLOR_CODE_PATTERN.split(text);
        int index = 0;
