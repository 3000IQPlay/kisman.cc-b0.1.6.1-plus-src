...
class CtNewWrappedMethod
{
    ...
    private static String addBodyMethod(final CtClassType clazz, final ClassFile classfile, final CtMethod src) throws BadBytecode, CannotCompileException {
        ...
        if (bodyname == null) {
            ...
            final MethodInfo body = new MethodInfo(classfile.getConstPool(), bodyname, src.getMethodInfo2(), (Map)map);
            ...
            if (cache != null) {
                cache.addMethod((CtMember)new CtMethod(body, (CtClass)clazz));
            }
        }
        return bodyname;
    }
