...
public class FieldAccess extends Expr
{
    ...
    public void replace(final String statement) throws CannotCompileException {
        ...
        try {
            ...
            if (read) {
                jc.recordProceed((ProceedHandler)new ProceedForRead(retType, this.opcode, index, paramVar));
            }
            else {
                jc.recordType(fieldType);
                jc.recordProceed((ProceedHandler)new ProceedForWrite(params[0], this.opcode, index, paramVar));
            }
