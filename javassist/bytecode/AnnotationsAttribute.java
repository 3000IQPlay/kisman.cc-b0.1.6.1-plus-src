...
public class AnnotationsAttribute extends AttributeInfo
{
    ...
    static class Copier extends Walker
    {
        ...
        Copier(final byte[] info, final ConstPool src, final ConstPool dest, final Map map, final boolean makeWriter) {
            ...
            if (makeWriter) {
                this.writer = new AnnotationsWriter((OutputStream)this.output, dest);
            }
            this.srcPool = src;
            this.destPool = dest;
            this.classnames = map;
    ...
    static class Parser extends Walker
    {
        ...
        void constValueMember(final int tag, final int index) throws Exception {
            ...
            switch (tag) {
                case 66: {
                    m = (MemberValue)new ByteMemberValue(index, cp);
                    break;
                }
                case 67: {
                    m = (MemberValue)new CharMemberValue(index, cp);
                    break;
                }
                case 68: {
                    m = (MemberValue)new DoubleMemberValue(index, cp);
                    break;
                }
                case 70: {
                    m = (MemberValue)new FloatMemberValue(index, cp);
                    break;
                }
                case 73: {
                    m = (MemberValue)new IntegerMemberValue(index, cp);
                    break;
                }
                case 74: {
                    m = (MemberValue)new LongMemberValue(index, cp);
                    break;
                }
                case 83: {
                    m = (MemberValue)new ShortMemberValue(index, cp);
                    break;
                }
                case 90: {
                    m = (MemberValue)new BooleanMemberValue(index, cp);
                    break;
                }
                case 115: {
                    m = (MemberValue)new StringMemberValue(index, cp);
                    break;
                }
                default: {
