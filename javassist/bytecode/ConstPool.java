...
public final class ConstPool
{
    ...
    int addConstInfoPadding() {
        return this.addItem0((ConstInfo)new ConstInfoPadding(this.numOfItems));
    }
    ...
    public int addClassInfo(final String qname) {
        ...
        return this.addItem((ConstInfo)new ClassInfo(utf8, this.numOfItems));
    }
    ...
    private int readOne(final DataInputStream in) throws IOException {
        ...
        switch (tag) {
            ...
            case 7: {
                info = (ConstInfo)new ClassInfo(in, this.numOfItems);
                break;
            }
            case 8: {
